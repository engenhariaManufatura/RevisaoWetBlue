...
function createDropDown (lst) {
  ...
  var str = 
  "<input type='button' class='btn btn-default dropdown-toggle' role='button' id='dropdownMenu' data-toggle='dropdown' aria-haspopup='true' aria-expanded='false' value='Teste'>" +
    "<span class='caret'></span></input>" + 
   "<ul class='dropdown-menu drop-down-menu-right btn' role='menu' aria-labelledby='dropdownMenuLink'>" ;
